...
$(document).ready(function () {
  ...
  function getDate() {
    ...
    var finalDate =
      d.getDate() + " " + d.getShortMonthName() + " " + d.getYear();
  ...
  $(".startGenerator").click(function () {
    if (!$(".active").length) {
      ...
      setTimeout(function () {
        ...
        $(".small-title").html("Code Packages");
            ...
            setTimeout(function () {
              ...
              setTimeout(function () {
                ...
                setTimeout(function () {
                  ...
                  $(".big-title").html("Done!");
                  $(".small-title").html("You injected app, wait few seconds");
